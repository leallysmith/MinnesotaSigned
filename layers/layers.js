...
lyr_GoogleTerrain_0.setVisible(true);lyr_GoogleImagery_1.setVisible(true);lyr_ESRIGray_2.setVisible(true);lyr_OpenStreetMap_3.setVisible(true);lyr_CoalClosureEnergyCommunities_4.setVisible(true);lyr_MSANonMSAsthatareEnergyCommunities_5.setVisible(true);lyr_AdditionalSelectionCriteriaGeographicOption2PersistentPovertyCounty_6.setVisible(true);lyr_AdditionalSelectionCriteriaGeographicOption1CEJSTEnergy_7.setVisible(true);lyr_Category1Eligibility_8.setVisible(true);lyr_XCEL_9.setVisible(true);lyr_Minnesota_10.setVisible(true);lyr_MinnesotaCounties_11.setVisible(true);lyr_MinnesotaCountyNames_12.setVisible(false);lyr_XCELSubstations_13.setVisible(true);lyr_SignedParcelslastupdated21224_14.setVisible(true);lyr_SignedParcelNameslastupdated21224_15.setVisible(false);
var layersList = [group_Basemaps,group_EnergyCommunities,group_48eLowIncomeCredits,lyr_XCEL_9,lyr_Minnesota_10,lyr_MinnesotaCounties_11,lyr_MinnesotaCountyNames_12,lyr_XCELSubstations_13,lyr_SignedParcelslastupdated21224_14,lyr_SignedParcelNameslastupdated21224_15];
...
lyr_XCELSubstations_13.set('fieldLabels', {'FID': 'no label', 'NAME': 'header label - visible with data', });
lyr_SignedParcelslastupdated21224_14.set('fieldLabels', {'Opportunity Name': 'no label', 'Account Name': 'no label', 'Lease Area (Acres or Square Feet)': 'no label', 'AO Link': 'no label', 'Site Lat/Long Coordinates (Latitude)': 'no label', 'Site Lat/Long Coordinates (Longitude)': 'no label', 'Market': 'no label', 'Utility': 'no label', });
